...
import {
  Home, Search, CalendarCheck, MessageSquare, User, Settings, LogOut, GraduationCap, PanelLeft, Calendar,
} from "lucide-react";
  ...
  return (
    <div className="flex flex-col h-full bg-primary text-primary-foreground">
      ...
      <nav className="flex-1 p-3 space-y-1">
        {navItems.map((item) => {
          const active = currentPath === item.path || (item.path === "/student" && currentPath === "/student/");
          return (
            <button
              key={item.path}
